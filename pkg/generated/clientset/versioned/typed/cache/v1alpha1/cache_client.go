...
import (
	...
	"github.com/harche/kata-operator/pkg/generated/clientset/versioned/scheme"
...
// CacheV1alpha1Client is used to interact with features provided by the cache.example.com group.
type CacheV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CacheV1alpha1Client) Kataconfigs(namespace string) KataconfigInterface {
