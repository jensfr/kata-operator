...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.Kataconfig{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cachev1alpha1.Kataconfig{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileKataconfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cachev1alpha1.Kataconfig{}
...
func newMCForCR(cr *cachev1alpha1.Kataconfig) *mcfgv1.MachineConfig {
	labels := map[string]string{
